...
FILES = [
    "tests/data/docx/sample-5pages.docx",
    "tests/data/docx/valid.docx",
    "tests/data/docx/tables.docx",
    "tests/data/docx/unicode.docx",
    "tests/data/docx/empty.docx",
    "tests/data/docx/missing.docx",
]
...
def main():
    ...
    for filename in FILES:
        ...
        try:
            ...
            loader = DOCXLoader(Path(filename))
